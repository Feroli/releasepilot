...
public class RollbackPromotionHandler {
    ...
    public RollbackPromotionHandler(PromotionCommandSupport support, ApproverDirectory approverDirectory) {
    ...
    public PromotionResponse handle(RollbackPromotionCommand command) {
        ...
        promotion.rollBack(command.actingUser(), approverDirectory.isApprover(command.actingUser()), command.reason(), support.now());
